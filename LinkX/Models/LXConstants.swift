...
public class LXConstants {
    ...
    static let REFERRAL = Activity(data: ["id" : "Refer a Friend", "name" : "Refer a Friend", "points" : 15.0, "description" : "When you refer a friend you get 15 points when they sign up."])
